...
//exit();
// 根据广告组获取下面的广告商品
$app->client->profileId= '3753569985456409';

$result = $app->campaigns->listCampaigns();
...
//$result = $app->groups->listAdGroups(['campaignIdFilter'=>243765249788831]);

//var_du
//mp($result);
//die();

//$result = $app->productAds->listProductAdsEx(['adGroupIdFilter'=>'190944355258966']);
...
// 创建广告商品投放策略
//$params = [
//    'campaignId'     => '243765249788831',
//    'adGroupId'      => "190944355258966",
////    'targetId'       => '47324418716338',
...
//    'bid'            => intval(11)
//];
//var_dump($app->productTargeting->createTargetingClauses([$params]));
//var_dump($app->productTargeting->listTargetingClauses());
die();
